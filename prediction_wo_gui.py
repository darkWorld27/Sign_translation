...
while True:
    try:
        ...
        if hands:
            ...
            white = cv2.imread("C:\\Users\\bijay\\Downloads\\Sign-Language-To-Text-and-Speech-Conversion-master\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg")
