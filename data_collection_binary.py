...
#testing data
count = len(os.listdir("K:\Sign-Language-To-Text-and-Speech-Conversion-master (2)\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\gray"))
...
cv2.imwrite("K:\Sign-Language-To-Text-and-Speech-Conversion-master (2)\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\white.jpg",white)
...
while True:
    try:
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread("K:\Sign-Language-To-Text-and-Speech-Conversion-master (2)\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\white.jpg")
            # img_final=img_final1=img_final2=0
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            # test data
            count = len(os.listdir("K:\Sign-Language-To-Text-and-Speech-Conversion-master (2)\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\gray" + p_dir + "//"))
        ...
        if flag==True:
            ...
            if step%2==0:
                ...
                #             img_final)
                cv2.imwrite("K:\Sign-Language-To-Text-and-Speech-Conversion-master (2)\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\gray" + p_dir + "\\" + c_dir + str(count) + ".jpg",
                            img_final1)
                cv2.imwrite(
                    "K:\Sign-Language-To-Text-and-Speech-Conversion-master (2)\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\gray" + p_dir + "\\" + c_dir + str(count) + ".jpg",
                    img_final2)
